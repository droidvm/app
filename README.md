...
#### 特别提示: 安装虚拟系统时，请保持虚拟电脑在前台运行!<br><br>
...
| 外设访问部分 |
|------------------|
| 外设目前仅支持 usb 串口, 用于连接3D打印机 |
| 不支持外接 usb 办公打印机 |
| 不支持虚拟系统中使用设备的摄像头、麦克风 |

| 软件适配相关 |
|------------------|
| 不支持 docker, 但可以安装 udocker |
| 不支持 systemd, 但 service 指令可用 |
| 不支持 appimage、flatpak 等安装包格式 |
